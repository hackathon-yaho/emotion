...
> **상태: ✅ 회신 완료 (2026-09-05)**
> 회신: [`../../response/backend/deploy-handoff.md`](../../response/backend/deploy-handoff.md)
> 요약 — ① `BACKEND_BASE_URL`은 **AI서버 배포와 동시에** 반영합니다(로컬은 그대로) ② **슬립 대 fail-closed는 cron이 맞습니다** — 복귀 60초를 타임아웃으로 덮으면 Hume이 먼저 끊습니다. ⚠️ **cron이 두 곳을 찔러야 합니다** — AI서버도 Cloud Run 무료라 잠듭니다 ③ **터널이 아니라 Cloud Run 배포로 갑니다.** 주소가 나오면 드립니다
>
> <sub>원래 배너</sub>
