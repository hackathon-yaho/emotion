...
| 문서 | 상태 | 내용 |
| --- | --- | --- |
| [summary-route-restarts-session.md](summary-route-restarts-session.md) | ⏳ **회신 대기** (2026-09-14, 요청자 백엔드) | 대화를 끝내면 **요약 라우트(`/conversation/summary`)가 대화 화면을 다시 만들어 세션을 하나 더 연다.** 「이어하기 7분」 카드가 가리킨 것이 이 빈 세션이었다. 빈 세션은 F3-04의 세션 수도 부풀린다 |
