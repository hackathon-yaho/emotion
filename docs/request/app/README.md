...
| 문서 | 상태 | 내용 |
| --- | --- | --- |
| [summary-route-restarts-session.md](summary-route-restarts-session.md) | ⏳ **회신 대기** (2026-09-14, 요청자 백엔드 · **09-15 개정**) | 대화를 끝내면 **요약 라우트(`/conversation/summary`)가 대화 화면을 다시 만들어 세션을 하나 더 연다.** 「이어하기 7분」 카드가 가리킨 것이 이 빈 세션이었다. **요약 화면에 머무는 동안 숨은 화면의 마이크가 Hume에 연결돼 있다**(실측 105·122초). `3d9c1a7`과 겹치면 요약이 지워질 것으로 보인다 |
